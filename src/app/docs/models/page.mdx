...
**Note:** Different models tokenize text in different ways. Some models break up
text into chunks of multiple characters (GPT, Claude, Llama, etc) while others
tokenize by character (PaLM). This means that the number of tokens may vary
depending on the model.

For more detailed information and up-to-date model listings, please refer to our
[full models documentation](https://targon.sybil.com/docs/models).
