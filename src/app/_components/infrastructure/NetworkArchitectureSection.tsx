...
const cardClasses =
  "rounded-2xl border border-gray-100 bg-mf-milk-300/50 p-6 backdrop-blur-sm";
const statCardClasses =
  "rounded-2xl border border-gray-100 bg-mf-milk-300/50 p-4 sm:p-6";

//  Reusable stat card component
const StatCard = ({ value, label }: { value: string; label: string }) => (
  <div className={statCardClasses}>
    <div className="text-2xl font-semibold text-mf-green-700 sm:text-3xl">
      {value}
    </div>
...
const FeatureCard = ({
  ...
  >
    ...
    <ul className="mt-4 list-inside list-disc space-y-3 text-sm leading-6 text-gray-600 marker:text-mf-green-700">
    ...
    >
      <div className="relative grid gap-8 lg:grid-cols-2 lg:gap-12">
        <div className="lg:sticky lg:top-8 lg:pt-12">
          ...
          >
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-mf-blue-900/10 sm:h-14 sm:w-14 lg:mx-0">
              <Network className="h-6 w-6 text-mf-green-700 sm:h-7 sm:w-7" />
            </div>
            <div>
        ...
        <div className="relative lg:pt-12">
          ...
          <div className="relative space-y-6 sm:space-y-8">
            {/* Large screens */}
            <div className="hidden aspect-[3/2] overflow-hidden rounded-2xl border border-gray-100 bg-mf-milk-300/50 shadow-xl sm:aspect-[4/3] lg:block xl:hidden">
              <NetworkAnimation variant="compact" />
            </div>
            {/* Larger screens -- not the biggest fan of doing it like this */}
            <div className="hidden aspect-[3/2] overflow-hidden rounded-2xl border border-gray-100 bg-mf-milk-300/50 shadow-xl sm:aspect-[4/3] xl:block">
