      ...
      <div className="h-full w-full">
        {!isHovered || !isHoverSupported ? (
          ...
          <Link
            ...
            className={isHoverSupported ? "md:pointer-events-none" : ""}
          >
          ...
          <div
            className={`absolute inset-0 flex h-full w-full flex-col bg-mf-green p-6 transition-all duration-300 ease-in-out ${
          ...
          >
            ...
            <div className="mt-auto space-y-4">
              ...
              <div className="flex items-center justify-between whitespace-nowrap">
                ...
                <Link
                  href={`/models/${encodeURIComponent(name)}`}
                  className="flex items-center gap-2 text-sm uppercase tracking-wider text-white"
                >
                  View More <span>→</span>
                </Link>
              </div>
