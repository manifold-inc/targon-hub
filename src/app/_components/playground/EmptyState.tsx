...
import { BrainCircuit, ImageIcon, Users } from "lucide-react";
    ...
    <div className="flex h-full w-full items-start justify-center sm:items-center">
      <div className="flex w-full flex-col items-center px-2 pb-2 pt-4 sm:px-4 sm:py-0">
        ...
        <div className="grid w-full max-w-3xl grid-cols-1 gap-2 pb-3 sm:grid-cols-2 sm:gap-3 sm:pb-6 lg:grid-cols-3 lg:gap-4 lg:pb-8">
          <div
            onClick={startChat}
            className="cursor-pointer rounded-lg bg-mf-blue-700/10 p-2.5 transition-colors hover:bg-mf-blue-700/20 sm:p-4 lg:p-6"
          >
          ...
          <div className="group cursor-not-allowed rounded-lg bg-mf-blue-700/5 p-2.5 backdrop-blur-[1px] sm:p-4 lg:p-6">
            ...
            <p className="text-[10px] text-mf-ash-300/50 sm:text-xs lg:text-sm">
