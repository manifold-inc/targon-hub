        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="font-medium text-[#101828] transition-colors group-hover:text-[#142900]">{name}</span>
              <ArrowUpRight className="h-4 w-4 text-[#98a1b2] transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-[#142900] group-hover:opacity-100" aria-hidden="true" />
            </div>
            {enabled ? (
          ...
          <div className="flex items-center gap-2 text-xs text-[#475467]">
            ...
            <span>{modality === "text-generation" ? "Text Generation" : "Text to Image"}</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs">
            <div className="flex items-center gap-2 text-[#344054] transition-colors group-hover:text-[#142900]">
              <span className="text-[#98a1b2] transition-colors group-hover:text-[#142900]/70">Created</span>
              {formattedDate}
            </div>
            ...
            {weeklyPrice && (
              <>
                <div className="h-3 w-px bg-[#e4e7ec]" />
                <div className="flex items-center gap-2 text-[#344054] transition-colors group-hover:text-[#142900]">
                  <span className="text-[#98a1b2] transition-colors group-hover:text-[#142900]/70">Price</span>
                  ${weeklyPrice}/week
                </div>
              </>
            )}
