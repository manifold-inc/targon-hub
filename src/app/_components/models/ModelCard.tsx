...
export default function ModelCard({
  ...
  return (
    <Link
      ...
      className="group relative flex items-start overflow-hidden rounded-xl border border-mf-silver-700 bg-mf-milk-300 p-3 transition-all duration-300 hover:bg-mf-milk-100 sm:p-4 md:p-5"
    >
