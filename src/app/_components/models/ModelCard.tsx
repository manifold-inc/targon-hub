...
export default function ModelCard({
  ...
  return (
    <Link
      ...
      className="group relative flex items-start overflow-hidden rounded-xl border border-mf-silver-700 bg-mf-milk-300 p-3 transition-all duration-300 hover:bg-mf-milk-100 hover:shadow-lg sm:p-4 md:p-5"
    >
      <div className="flex min-w-0 flex-1 flex-col gap-2 sm:gap-3 md:gap-4">
        <div className="flex items-start justify-between gap-2 sm:gap-3">
          ...
          <div className="flex items-start gap-1.5 sm:gap-2">
            {enabled ? (
              <div className="flex min-w-16 items-center justify-center gap-1 whitespace-nowrap rounded-full bg-mf-green-700/20 px-2 py-0.5 text-xs font-semibold text-mf-green-700 sm:min-w-[72px] sm:gap-1.5 sm:px-2 sm:text-xs">
                <div className="h-1 w-1 animate-pulse rounded-full bg-mf-green-700" />
                Live
              </div>
            ) : (
              <div className="flex min-w-16 items-center justify-center gap-1 whitespace-nowrap rounded-full bg-mf-blue-700/20 px-2 py-0.5 text-xs font-semibold text-mf-blue-700 sm:min-w-[72px] sm:gap-1.5 sm:px-2 sm:text-xs">
